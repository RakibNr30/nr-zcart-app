...
// END NEW CODE //////////////////////////
    ...
    function setShippingCost(shipping)
    {
        ...
        if (free_shipping == 1 && shipping.rate == 0) {
            ...
            var start_date = date.addDays(date1).toDateString();
            var last_date = date.addDays(date2).toDateString();
            
            var approx_date_no = "Between <b>" + start_date + " and " + last_date + ".</b> on today's receipt of payment <br>" + 
			                            "<span class='text-muted' style='font-size:11px;font-weight:bold;display: inline-flex;'>Please allow more time for international shipments to clear customs.</span>";
            ...
            $('#approx-date').html(approx_date_no);
            ...
            var str = shipping.delivery_takes;
            ...
            var approx_date = "Between <b>" + start_date + " and " + last_date + ".</b> on today's receipt of payment <br>" + 
			                            "<span class='text-muted' style='font-size:11px;font-weight:bold;display: inline-flex;'>Please allow more time for international shipments to clear customs.</span>";
            
            $('#approx-date').html(approx_date);
