          ...
          <li class="treeview {{ Request::is('admin/order*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
                ...
                <li class="{{ Request::is('admin/reviews/add_fake*') ? 'active' : '' }}">
                  <a href="{{ url('admin/reviews/add_fake') }}">
                    <i class="fa fa-angle-double-right"></i> Add reviews
                  </a>
                </li>    
                
                <li class="{{ Request::is('admin/reviews/add_csv*') ? 'active' : '' }}">
                  <a href="{{ url('admin/reviews/add_csv') }}">
                    <i class="fa fa-angle-double-right"></i> Add reviews (CSV)
                  </a>
                </li>   
