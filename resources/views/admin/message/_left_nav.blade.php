...
<a href="javascript:void(0)" data-link="{{ route('admin.support.message.create', 'template') }}"  class="ajax-modal-btn btn btn-info btn-lg btn-block">{{ trans('app.new_message_with_template') }}</a>

<a href="/sendbasicemail" class="btn btn-info btn-lg btn-block margin-bottom">Send email</a>
